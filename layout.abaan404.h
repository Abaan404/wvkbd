...
static struct key keys_landscape[] = {
  ...
  {"Caps Lock", "Caps Lock", 1.5, Mod, CapsLock, .scheme = 1},
  {"", "", 0.5, Pad, .scheme = 1},
  {"a", "A", 1.0, Code, KEY_A, &layouts[ComposeA]},
  {"s", "S", 1.0, Code, KEY_S, &layouts[ComposeS]},
  {"d", "D", 1.0, Code, KEY_D, &layouts[ComposeD]},
  ...
  {"⌫", "⌫", 1.75, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},
...
static struct key keys_landscape_special[] = {
  ...
  {"0", ")", 1.0, Code, KEY_0, &layouts[ComposeBracket]},
  {"", "", 0.5, Pad, .scheme = 1},
  {"⇈", "⇈", 0.5, Code, KEY_PAGEUP, .scheme = 1},
  {"⇊", "⇊", 0.5, Code, KEY_PAGEDOWN, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"⇤", "⇤", 0.75, Code, KEY_HOME, .scheme = 1},
  {"⇥", "⇥", 0.75, Code, KEY_END, .scheme = 1},
  {"", "", 0.5, Pad, .scheme = 1},
  {"🙂", "🙂", 1.0, Layout, 0, &layouts[Emoji]},
  {"`", "~", 1.0, Code, KEY_GRAVE},
  {"'", "\"", 1.0, Code, KEY_APOSTROPHE},
